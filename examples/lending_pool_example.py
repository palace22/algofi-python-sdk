...
txn.sign_with_private_keys(
    [key] * 3 + [PERMISSIONLESS_SENDER_LOGIC_SIG] * 6, [False] * 3 + [True] * 6
)
...
txn.sign_with_private_keys(
    [key] * 2 + [PERMISSIONLESS_SENDER_LOGIC_SIG] * 3, [False] * 2 + [True] * 3
)
txn.submit(client.algod)
...
txn.sign_with_private_keys(
    [key] * 2 + [PERMISSIONLESS_SENDER_LOGIC_SIG] * 4, [False] * 2 + [True] * 4
)
txn.submit(client.algod)
