...
LENDING_POOL_INTERFACE_CONFIGS = {
    Network.MAINNET: [
        LendingPoolInterfaceConfig(841198034, 31566704, 841126810, 841171328, 818182048, 841145020, 841194726, 841170409, PoolType.NANOSWAP, 841189050), # bUSDC / bSTBL2
        LendingPoolInterfaceConfig(856198764, 1, 841126810, 855717054, 818179346, 841145020, 856183130, 855716333, PoolType.CONSTANT_PRODUCT_25BP_FEE ,841189050), # bALGO / bSTBL2
        LendingPoolInterfaceConfig(870281048, 386192725, 841126810, 870151164, 818183964, 841145020, 870271921, 870150391, PoolType.CONSTANT_PRODUCT_25BP_FEE ,841189050), # bgoBTC / bSTBL2
        LendingPoolInterfaceConfig(870281567, 386195940, 841126810, 870150187, 818188286, 841145020, 870275741, 870143131, PoolType.CONSTANT_PRODUCT_25BP_FEE ,841189050), # bgoETH / bSTBL2
    ],
    Network.TESTNET: [
