...
class Staking:
    ...
    def load_state(self, block=None):
        ...
        self.rewards_escrow_account = encode_address(
            b64decode(global_state.get(STAKING_STRINGS.rewards_escrow_account, ""))
        )
        ...
        self.rewards_manager_app_id = global_state[
        ...
        for i in range(self.rewards_program_count):
            self.rewards_program_states[i] = RewardsProgramState(
                self, global_state, formatted_state, i
            )
    ...
    def get_stake_txns(self, user, b_asset_amount, params=None):
        ...
        txn1 = get_payment_txn(
            user.address, params, self.address, b_asset_amount, self.asset_id
        )
        ...
        txn2 = ApplicationNoOpTxn(
            user.address, params, self.app_id, app_args2, foreign_apps=foreign_apps2
        )
    ...
    def get_unstake_txns(self, user, b_asset_amount, params=None):
        ...
        params.fee = 3000
        app_args1 = [
            bytes(STAKING_STRINGS.unstake, "utf-8"),
    ...
    def get_claim_txns(self, user, params=None):
        ...
        for i in range(self.rewards_program_count):
            if (
                user.user_staking_states[self.app_id]
                .user_rewards_program_states[i]
                ...
                params.fee = 3000
                app_args1 = [
                    bytes(STAKING_STRINGS.claim_rewards, "utf-8"),
                    int_to_bytes(i),
                ]
