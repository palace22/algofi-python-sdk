...
MAINNET_NANOSWAP_POOLS_ASSET_PAIR_TO_APP_ID = {
    (31566704, 465865291): 658337046, # USDC / STBL
    (312769, 465865291): 659677335, # USDT / STBL
    (312769, 31566704): 659678644, # USDT / USDC
}
...
MAINNET_NANOSWAP_POOLS_ASSET_PAIR_TO_MANAGER_APP_ID = {
    (31566704, 465865291): 658336870, # USDC / STBL
    (312769, 465865291): 658336870, # USDT / STBL
    (312769, 31566704): 658336870, # USDT / USDC
}

# lending pool app ids
# (asset1_id, asset2_id) -> pool_app_id
NANOSWAP_LENDING_POOLS_ASSET_PAIR_TO_APP_ID = {(818182311, 841157954): 841170409} # bUSDC / bSTBL2
CONSTANT_PRODUCT_LENDING_POOLS_ASSET_PAIR_TO_APP_ID = {
    (818179690, 841157954): 855716333, # bALGO / bSTBL2
    (818184214, 841157954): 870150391, # bgoBTC / bSTBL2
    (818188553, 841157954): 870143131, # bgoETH / bSTBL2
    (841157954, 900919286): 900923609, # bSTBL2 / bBANK
    (818179690, 818182311): 919950071, # bALGO / bUSDC
    (818179690, 900919286): 962367416, # bALGO / bBANK
}

# lending pool manager app ids
# (asset1_id, asset2_id) -> manager_app_id
NANOSWAP_LENDING_POOLS_ASSET_PAIR_TO_MANAGER_APP_ID = {
    (818182311, 841157954): 841165954 # bUSDC / bSTBL2
}
CONSTANT_PRODUCT_LENDING_POOLS_ASSET_PAIR_TO_MANAGER_APP_ID = {
    (818179690, 841157954): 841165954, # bALGO / bSTBL2
    (818184214, 841157954): 841165954, # bgoBTC / bSTBL2
    (818188553, 841157954): 841165954, # bgoETH / bSTBL2
    (841157954, 900919286): 841165954, # bSTBL2 / bBANK
    (818179690, 818182311): 841165954, # bALGO / bUSDC
    (818179690, 900919286): 841165954, # bALGO / bBANK
}
